...
- Home plot introduced at end of floor 2

- added home plot loot to find on floor 2, 3 and 4

- traders on floor 3, 4 have home plot items to sell

- Npc path finbding updated for forced encounters so they dont get stuck by collisions

- Npc interaction notification removed for forced encounters 


# Chnage Log 20/4/26

- Floors 5 - 6 dialouge has been updated to match previous floors
